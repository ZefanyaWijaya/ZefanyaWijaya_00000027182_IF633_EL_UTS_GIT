...
public class Listlagu_Activity extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Listlagu_Activity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
                Intent intent = new Intent(getApplicationContext(), Porfile_Activity.class);
